<template>
    <p>
        Your phone number will be removed from this account, and SMS 2FA will be disabled!
      </p>
    <p>
        enter SMS code
      </p>
    ...
    const submit = async () => {
      showError.value = !(await auth.confirmRemovePhoneNumber(user1));
